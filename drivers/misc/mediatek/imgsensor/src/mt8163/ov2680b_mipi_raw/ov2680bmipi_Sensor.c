...
#include "ov2680bmipi_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "OV2680B_camera_sensor"
#define LOG_1 LOG_INF("OV2680B,MIPI 1LANE\n")
...
static unsigned int WhoAmI = 2680;
static unsigned int ATD_ov2680b_status;
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = 0x2680, //OV2680BMIPI_SENSOR_ID,  /*sensor_id = 0x2680*/ //record sensor id defined in Kd_imgsensor.h
...
/*according toov2680b datasheet p53 image cropping*/
...
static void set_dummy(void)
{
	...
	/*  Add dummy pixels: */
    /* 0x380c [0:4], 0x380d defines the PCLKs in one line of OV2680B  */  
    /* Add dummy lines:*/
    /* 0x380e [0:1], 0x380f defines total lines in one frame of OV2680B */
...
//ASUS_BSP+++, ATD
static int ov2680b_dbgfs_init(void)
{
	struct dentry *debugfs_dir;

	debugfs_dir = debugfs_create_dir("camera0", NULL);
	debugfs_create_u32("camera_status", 0644, debugfs_dir, &ATD_ov2680b_status);
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) 
{
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				//ASUS_BSP+++, ATD
				if(probed == 0) {
					ATD_ov2680b_status = 1;
					ov2680b_dbgfs_init(); //ATD camera status
					probed = 1;
				}
				//ASUS_BSP---, ATD
	...
	if (*sensor_id != imgsensor_info.sensor_id) {
		//ASUS_BSP+++, ATD
		if(probed == 0) {
			ATD_ov2680b_status = 0;
			#if defined(CONFIG_Z380M)
			ov2680b_dbgfs_init(); //ASUS_BSP+++ ATD camera status
			#endif
...
/*UINT32 OV2680B_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)*/
UINT32 OV2680BMIPISensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
