...
DOMAIN_INFO_ENTRY arSupportedRegDomains[] = {
	...
	,
	{
	 (PUINT_16) g_u2CountryGroup18, sizeof(g_u2CountryGroup18) / 2,
	 {
	  ...
	  ,			/* CH_SET_UNII_LOW_36_48 */
	  {118, BAND_5G, CHNL_SPAN_20, 56, 3, FALSE}
...
static UINT_16 g_u2CountryGroup5_Passive[] = {
        COUNTRY_CODE_JP
};
