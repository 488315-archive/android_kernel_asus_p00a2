...
/*Global*/
extern signed long BAT_TASK_PERIOD;
extern kal_bool chr_wake_up_for_meter_check;
extern kal_bool chr_wake_up_for_meter_charging;
extern kal_bool chr_wake_up_for_meter_discharging;
/*****************************************************************************
 *  Enum
 ****************************************************************************/
...
typedef struct {
	...
	unsigned int ZCV;
	unsigned int old_charging_mode;
	unsigned int cover_SOC;
} PMU_ChargerStruct;
