...
int auo_lcm_vgp_supply_enable(void)
{
	int ret;
	unsigned int volt;
...
int auo_lcm_vgp_supply_disable(void)
{
	int ret = 0;
...
LCM_DRIVER z380m_auo_rm72014_lcm_drv = {
	.name = "z380m_auo_rm72014",
...
static int __init lcm_init(void)
{
	...
	if (!strcmp(z380m_auo_rm72014_lcm_drv.name, lk_lcmname)) {
